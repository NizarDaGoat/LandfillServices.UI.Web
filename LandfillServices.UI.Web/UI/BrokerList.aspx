<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BrokerList.aspx.cs" Inherits="LandfillServices.UI.Web.UI.BrokerList" %>
                            ...
                            <asp:Repeater ID="RepeaterListUser" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href='/UI/BrokerEdit.aspx?ID=<%# Eval("ID") %>'>
