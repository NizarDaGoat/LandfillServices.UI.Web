<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PassageLandfillList.aspx.cs" Inherits="LandfillServices.UI.Web.UI.PassageLandfillList" %>
                        ...
                        <div class="table-responsive">
                            <asp:Repeater ID="RepeaterListPassageLandfill" runat="server">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%-- Need to write it again but the same naming as the variablre declared in the SQL server database--%>
                                            </td>
                                        <td>
