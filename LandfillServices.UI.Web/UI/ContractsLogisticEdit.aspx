<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContractsLogisticEdit.aspx.cs" Inherits="LandfillServices.UI.Web.UI.ContractsLogisticEdit" %>
                            ...
                            <asp:Panel runat="server" ID="PanelControlsValues" Visible="false">
                                <div class="col-lg-12">
                                    <div class="alert alert-warning">
                                        <a href="#" class="close" data-dismiss="alert">&times;</a>
                                        <strong></strong>The Logistic and subsciption date is required
                                    </div>
                                </div>
                            </asp:Panel>
                            <div class="form-group">
                                <label class="col-lg-4 control-label">Logistic *</label>
                                <div class="col-lg-2">
                                    <asp:DropDownList ID="DropDownListLogistic" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Contrats Logistic Remunerated Settings
                </div>
                <div class="form-horizontal panel-body">
                    <div class="form-group">
