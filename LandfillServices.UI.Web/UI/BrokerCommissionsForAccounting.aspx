<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BrokerCommissionsForAccounting.aspx.cs" Inherits="LandfillServices.UI.Web.UI.BrokerCommissionsForAccounting" %>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Broker commissions to accounting</h5>
                        ...
                        <div class="table-responsive">
                            <div class="table table-striped table-bordered table-hover table-responsive SelecteurGridView">
                                <asp:GridView ID="GridViewCommissions" runat="server" OnRowCreated="GridViewCommissions_RowCreated"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="CompanyCoperateName" HeaderText="Broker" SortExpression="CompanyCoperateName" />
