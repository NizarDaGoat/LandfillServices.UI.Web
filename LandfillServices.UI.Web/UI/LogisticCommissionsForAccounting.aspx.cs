...
{
    public partial class LogisticCommissionsForAccounting : System.Web.UI.Page
    {
        ...
        protected void ButtonSelect_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in GridViewCommissions.Rows)
            {
                ...
                if (cb != null && cb.Checked)
                {
                    ...
                    ObjectsFunctions.LogisticPaymentCommission commission = ControllerFunctions.LogisticPaymentCommissionController.SearchByID(commissionID);

                    if (commission != null)
                    {
                        sumAmount += commission.Amount;

                        ObjectsFunctions.LogisticAccounting LogisticAccounting = ControllerFunctions.LogisticAccountingController.SearchForAgregate(commission.LogisticTurnCollect.ContractsLogistic.LogisticID);
                        if (LogisticAccounting != null)
                        {
                            commission.LogisticAccountingID = LogisticAccounting.ID;
                            commission.PaymentDate = DateTime.Now.Date;
                            ControllerFunctions.LogisticPaymentCommissionController.Save(commission);
                        }
                        else
                        {
                            var newLogisticAccounting = new ObjectsFunctions.LogisticAccounting();
                            newLogisticAccounting.LogisticID = commission.LogisticTurnCollect.ContractsLogistic.LogisticID;
                            ControllerFunctions.LogisticAccountingController.Save(newLogisticAccounting);

                            commission.LogisticAccountingID = newLogisticAccounting.ID;
                            commission.PaymentDate = DateTime.Now.Date;
                            ControllerFunctions.LogisticPaymentCommissionController.Save(commission);
                        }
        ...
        private List<ObjectsFunctions.LogisticPaymentCommission> getDatasource()
        {
            List<ObjectsFunctions.LogisticPaymentCommission> bllCommissionList = ControllerFunctions.LogisticPaymentCommissionController.SearchToAccounting();
